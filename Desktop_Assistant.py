...
def passw_recognition():
    ...
    try:
        print("Recognizing...")    
        password = r.recognize_google(audio, language='en-in') #Using google for voice recognition.
...
def task_recognition():
    ...
    try:
        print("Recognizing...")    
        question = r.recognize_google(audio, language='en-in') #Using google for voice recognition.
        print(f"User said: {question}\n")  #User query will be printed.
        
    except Exception as e:
        print(" can't Recognize Say that again please...")   #Say that again will be printed in case of improper voice 
        return "None" #None string will be returned
    return question
